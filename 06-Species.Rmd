...
The three genotypes correspond to the previously identified two morphotypes (70-80%) *S. globulifera* and *S. sp1*, with *S. globulifera* morphotype structured in two gene pools, which might match the two identified submorphotype in Paracou called *S. globulifera type Paracou* (80%) and *S. globulifera type Régina* (20%). 
Interestingly, we noticed so-called *Paracou type* and *Régina type* within *S. globulifera* morphotype when sampling the individuals.
And looking to few identified individuals bark, 
the two identified gene pools correspond two this two morphotypes (Fig. \@ref(fig:populationMorphotypes)). 
The *Paracou type* have a smoother and thinner bark compared to the thick and lashed bark of *Régina type*.
...
19 individual, belonging to all gene pools, had only negative kinship values. 
